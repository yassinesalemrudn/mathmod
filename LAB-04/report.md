...
author: "Оулед Салем Яссин	НПИбд-02-20"
...
силы $\ddot{x}+4\dot{x}+8x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+3\dot{x}+4x=5\sin{2t}$

На итнтервале $t \in [ 0;55 ]$, шаг 0.05, $x_0=0, y_0=-2$
