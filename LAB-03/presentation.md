...
В начальный момент времени страна $X$ имеет армию численностью 50000 человек, а в распоряжении страны $Y$ армия численностью в 39000 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.445(t) - 0.806y(t) + sin(t+7)+1
	\\   
	\frac{dy}{dt}= -0.419x(t) - 0.709y(t) + cos(t+4)+1
 \end{cases}
$$
